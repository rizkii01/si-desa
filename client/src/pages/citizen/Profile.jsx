  ...
  return (
    <div className="max-w-2xl">
      <div className="flex items-center justify-between mb-6">
        ...
        <Link to="/warga/edit-profile" className="px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 transition">
          Edit Profil
        </Link>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border p-6">
        <div className="flex items-center gap-6 mb-6 pb-6 border-b">
          {profile.foto_profil ? (
            <img src={profile.foto_profil} alt="foto profil" className="w-24 h-24 rounded-full object-cover border-2 border-gray-200" />
          ) : (
            <div className="w-24 h-24 rounded-full bg-blue-100 flex items-center justify-center text-4xl text-blue-600 font-bold border-2 border-gray-200">{displayName(profile).charAt(0) || "?"}</div>
          )}
          <div>
